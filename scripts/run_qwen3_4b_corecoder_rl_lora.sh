...
SLIME_ROOT=${SLIME_ROOT:-/root/CoreCoder/slime}
...
export CORECODER_TEACHER_USE_REFERENCE_ANSWER="${CORECODER_TEACHER_USE_REFERENCE_ANSWER:-1}"
export CORECODER_TEACHER_EXTRA_PROMPT_ENABLED="${CORECODER_TEACHER_EXTRA_PROMPT_ENABLED:-1}"
export CORECODER_TEACHER_EXTRA_PROMPT_MODEL="${CORECODER_TEACHER_EXTRA_PROMPT_MODEL:-deepseek-v4-flash}"
export DEEPSEEK_BASE_URL="${DEEPSEEK_BASE_URL:-https://api.deepseek.com}"
export CORECODER_OPSD_TOKEN_LOGRATIO_CLIP="${CORECODER_OPSD_TOKEN_LOGRATIO_CLIP:-5.0}"
export CORECODER_OPSD_POINTWISE_KL_CLIP="${CORECODER_OPSD_POINTWISE_KL_CLIP:-5.0}"
export CORECODER_OPSD_TEACHER_TOPK="${CORECODER_OPSD_TEACHER_TOPK:-32}"
export CORECODER_OPSD_KL_CHUNK_SIZE="${CORECODER_OPSD_KL_CHUNK_SIZE:-256}"
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
    ...
    \"CORECODER_RL_METHOD\": \"${CORECODER_RL_METHOD:-}\",
    \"CORECODER_TEACHER_LOGPROB_ENABLED\": \"${CORECODER_TEACHER_LOGPROB_ENABLED}\",
    \"CORECODER_TEACHER_USE_REFERENCE_ANSWER\": \"${CORECODER_TEACHER_USE_REFERENCE_ANSWER}\",
    \"CORECODER_TEACHER_EXTRA_PROMPT_ENABLED\": \"${CORECODER_TEACHER_EXTRA_PROMPT_ENABLED}\",
    \"CORECODER_TEACHER_EXTRA_PROMPT_MODEL\": \"${CORECODER_TEACHER_EXTRA_PROMPT_MODEL}\",
    \"DEEPSEEK_BASE_URL\": \"${DEEPSEEK_BASE_URL}\",
    \"CORECODER_OPSD_TOKEN_LOGRATIO_CLIP\": \"${CORECODER_OPSD_TOKEN_LOGRATIO_CLIP}\",
    \"CORECODER_OPSD_POINTWISE_KL_CLIP\": \"${CORECODER_OPSD_POINTWISE_KL_CLIP}\",
    \"CORECODER_OPSD_TEACHER_TOPK\": \"${CORECODER_OPSD_TEACHER_TOPK}\",
    \"CORECODER_OPSD_KL_CHUNK_SIZE\": \"${CORECODER_OPSD_KL_CHUNK_SIZE}\",
    \"PRM_M\": \"${PRM_M}\"
  }
}"
